@extends('layout')
@section('title', 'Cargo and Shipping | SEUN LAFE MULTIBIZ')
@section('content')
...
<section class="page-title" style="background-image: url(/images/background/page-title.jpg);">
    <div class="auto-container">
        <div class="title-outer">
            <h1 class="title">Cargo and Shipping</h1>
		...
		<div class="row">
			...
			<div class="col-xl-8 col-lg-8">
				<div class="services-details__content">
					<img src="/images/resource/p-6.jpg" alt="Cargo and Shipping" />
					<h2 class="mt-4">Comprehensive Cargo & Shipping Solutions</h2>
					<p><strong>SEUN LAFE MULTIBIZ</strong> delivers reliable and efficient <strong>Cargo and Shipping Services</strong> designed to meet the needs of businesses and individuals across Nigeria and beyond. With a strong foundation in logistics and general merchandise, we ensure your goods are transported safely, securely, and on time—every time.</p>
					<ul>
						<li>Haulage and delivery services by land, air, and sea</li>
						<li>Custom logistics solutions for businesses and projects</li>
						<li>End-to-end freight management and tracking</li>
						<li>Transparent pricing and dependable service</li>
						<li>Experienced team dedicated to your satisfaction</li>
					</ul>
					<p>Our commitment to innovation, efficiency, and client-focused service makes us the preferred partner for all your cargo and shipping needs. Let us handle your logistics, so you can focus on growing your business.</p>
					<p>Ready to move your goods or need a tailored shipping solution? <a href="{{ route('contact') }}">Contact us here</a> and our team will respond promptly.</p>
				</div>
			</div>

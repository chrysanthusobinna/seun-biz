@extends('layout')
@section('title', 'Ticketing & Reservation | SEUN LAFE MULTIBIZ')
@section('content')
...
<section class="page-title" style="background-image: url(/images/resource/service-1.jpg);">
    <div class="auto-container">
        <div class="title-outer">
            <h1 class="title">Ticketing & Reservation</h1>
		...
		<div class="row">
			...
			<div class="col-xl-8 col-lg-8">
				<div class="services-details__content">
					<img src="/images/resource/p-1.jpg" alt="Ticketing & Reservation" />
					<h2 class="mt-4">Seamless Ticketing & Reservation Services</h2>
					<p><strong>SEUN LAFE MULTIBIZ</strong> offers comprehensive <strong>Ticketing & Reservation</strong> solutions for individuals, groups, and businesses. With a focus on convenience, reliability, and value, we make booking your next trip, event, or service easy and stress-free.</p>
					<ul>
						<li>Flight, bus, and train ticket bookings</li>
						<li>Hotel and accommodation reservations</li>
						<li>Event and tour package bookings</li>
						<li>Flexible options for local and international travel</li>
						<li>Transparent pricing and dedicated support</li>
					</ul>
					<p>Our experienced team leverages strong industry partnerships to secure the best deals and ensure a smooth reservation process from start to finish. Trust SEUN LAFE MULTIBIZ to handle your ticketing and reservations with professionalism and care.</p>
					<p>Ready to book or need a custom reservation solution? <a href="{{ route('contact') }}">Contact us here</a> and our team will assist you promptly.</p>
				</div>
			</div>

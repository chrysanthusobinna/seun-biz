@extends('layout')
@section('title', 'Chartered Aircraft Service | SEUN LAFE MULTIBIZ')
@section('content')
...
<section class="page-title" style="background-image: url(/images/background/page-title.jpg);">
    <div class="auto-container">
        <div class="title-outer">
            <h1 class="title">Chartered Aircraft Service</h1>
		...
		<div class="row">
			...
			<div class="col-xl-8 col-lg-8">
				<div class="services-details__content">
					<img src="/images/resource/p-12.jpg" alt="Chartered Aircraft Service" />
					<h2 class="mt-4">Luxury & Flexibility with Chartered Aircraft Service</h2>
					<p><strong>SEUN LAFE MULTIBIZ</strong> offers exclusive <strong>Chartered Aircraft Services</strong> for business and leisure travelers seeking comfort, privacy, and efficiency. Our tailored solutions ensure you reach your destination on your schedule, with the highest standards of safety and service.</p>
					<ul>
						<li>Private jet and helicopter charters</li>
						<li>Flexible scheduling and custom routes</li>
						<li>VIP ground handling and concierge support</li>
						<li>Discreet, secure, and reliable operations</li>
						<li>Ideal for executives, groups, and special occasions</li>
					</ul>
					<p>We are committed to delivering value, luxury, and peace of mind—making every journey exceptional. Let SEUN LAFE MULTIBIZ be your trusted partner for chartered flights and premium travel experiences.</p>
					<p>Ready to book a charter or need a custom aviation solution? <a href="{{ route('contact') }}">Contact us here</a> and our team will assist you promptly.</p>
				</div>
			</div>

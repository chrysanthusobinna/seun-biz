@extends('layout')
@section('title', 'Immigration & Protocol | SEUN LAFE MULTIBIZ')
@section('content')
...
<section class="page-title" style="background-image: url(/images/background/page-title.jpg);">
    <div class="auto-container">
        <div class="title-outer">
            <h1 class="title">Immigration & Protocol</h1>
		...
		<div class="row">
			...
			<div class="col-xl-8 col-lg-8">
				<div class="services-details__content">
					<img src="/images/resource/p-9.jpg" alt="Immigration & Protocol" />
					<h2 class="mt-4">Expert Immigration & Protocol Services</h2>
					<p><strong>SEUN LAFE MULTIBIZ</strong> provides professional <strong>Immigration & Protocol</strong> services to individuals, families, and organizations. Our experienced team ensures compliance, efficiency, and peace of mind throughout your immigration and protocol processes.</p>
					<ul>
						<li>Visa application and processing support</li>
						<li>Residence and work permit assistance</li>
						<li>Protocol services for dignitaries and corporate clients</li>
						<li>Guidance on immigration regulations and requirements</li>
						<li>Confidential, reliable, and timely service</li>
					</ul>
					<p>We are committed to delivering value, integrity, and responsive support—helping you navigate complex immigration and protocol matters with confidence. Let SEUN LAFE MULTIBIZ be your trusted partner for all your immigration needs.</p>
					<p>Need assistance or want to discuss your immigration or protocol requirements? <a href="{{ route('contact') }}">Contact us here</a> and our team will assist you promptly.</p>
				</div>
			</div>

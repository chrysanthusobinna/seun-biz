@extends('layout')
@section('title', 'Visa Counselling Support Services | SEUN LAFE MULTIBIZ')
@section('content')
...
<section class="page-title" style="background-image: url(/images/background/page-title.jpg);">
    <div class="auto-container">
        <div class="title-outer">
            <h1 class="title">Visa Counselling Support Services</h1>
		...
		<div class="row">
			...
			<div class="col-xl-8 col-lg-8">
				<div class="services-details__content">
					<img src="/images/resource/p-10.jpg" alt="Visa Counselling Support Services" />
					<h2 class="mt-4">Professional Visa Counselling & Support</h2>
					<p><strong>SEUN LAFE MULTIBIZ</strong> offers expert <strong>Visa Counselling Support Services</strong> to guide individuals, families, and organizations through the complexities of visa applications and travel requirements. Our knowledgeable team provides personalized advice and hands-on support for a smooth, successful process.</p>
					<ul>
						<li>Comprehensive visa counselling for all destinations</li>
						<li>Document preparation and application review</li>
						<li>Guidance on requirements and interview preparation</li>
						<li>Support for student, business, and tourist visas</li>
						<li>Confidential, reliable, and up-to-date information</li>
					</ul>
					<p>We are committed to delivering value, clarity, and responsive service—helping you achieve your travel and immigration goals with confidence. Let SEUN LAFE MULTIBIZ be your trusted partner for visa support.</p>
					<p>Need help with your visa application or want to discuss your options? <a href="{{ route('contact') }}">Contact us here</a> and our team will assist you promptly.</p>
				</div>
			</div>
